...
## Browser unsichtbar im Hintergrund wegen headless_browser=True
    ...
    with smart_run(session):
        ...
        ## Der Bot wird zwischendurch ca. 600 Sekunden schlafen um keine Limits
        ## von Instagram zu verletzen und wie ein normaler Nutzer zu wirken.      
        session.follow_user_followers(random_targets, amount=random.randint(50,80), randomize=True, sleep_delay=600, interact=True)
